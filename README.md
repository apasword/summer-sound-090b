...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-sound-090b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/summer-sound-090b
```

A live public deployment of this template is available at [https://summer-sound-090b.templates.workers.dev](https://summer-sound-090b.templates.workers.dev)
